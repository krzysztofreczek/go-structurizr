...
// Each object of package that does not match any of predefined package prefixes is omitted and its internal structure is not scraped.
// When no package prefix is provided, the scraper will stop scraping given structure on a root level.
